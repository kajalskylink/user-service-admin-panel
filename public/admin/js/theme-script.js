                        ...
                        <div class="row gx-3">
                                ...
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="defaultLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/default.svg" alt="img">
                                        </span>                                     
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="miniLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/mini.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontalLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/horizontal.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontal-singleLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/horizontal-single.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="twocolumnLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/two-column.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="without-headerLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/without-header.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontal-overlayLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/overlay.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontal-sidemenuLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/menu-aside.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="stackedLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/stacked.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="modernLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/modern.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="transparentLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/transparent.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <a href="layout-rtl.html" class="theme-layout mb-3">
                                    <span class="d-block mb-2 layout-img">
                                        <img src="`+base_path+`/img/theme/rtl.svg" alt="img">
                                    </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="borderedCard">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/bordered.svg" alt="img">
                                        </span>                                     
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="borderlessCard">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/borderless.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="shadowCard">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/shadow.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="compactSize">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/compact.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="hoverviewSize">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="`+base_path+`/img/theme/hoverview.svg" alt="img">
                                        </span>                                    
