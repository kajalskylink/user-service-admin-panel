    ...
    <div class="main-header">
        ...
        <div class="header-left">
            <a href="index.html" class="logo">
                <img src="{{ asset('img/logo.png') }}" alt="Logo" style="height: 40px; width: 100px;">
            </a>
                    ...
                    <div class="sidebar-menu">
                        <div class="main-menu">
                            <ul class="nav-menu">
                                ...
                                <li>
                                    <a href="{{ route('dashboard') }}" class="{{ Route::currentRouteName() == 'admin.home' || Route::currentRouteName() == 'dashboard' ? 'active' : '' }}"><i class="ti ti-smart-home"></i><span>Dashboard</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
