                    ...
                    <ul>
                        <li>
                            <a href="{{ route('dashboard') }}"
                                class="{{ Route::currentRouteName() == 'admin.home' || Route::currentRouteName() == 'dashboard' ? 'active subdrop' : '' }}">
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('users.index') }}"
                                class="{{ Route::currentRouteName() == 'users.index' ? 'active subdrop' : '' }}">
                                <i class="ti ti-smart-home"></i>
                                <span>Users</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('permissions.index') }}"
                                class="{{ Route::currentRouteName() == 'permissions.index' ? 'active subdrop' : '' }}">
                                <i class="ti ti-smart-home"></i>
        ...
        <div class="main-menu">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('permissions.index') }}" class="{{ request()->routeIs('permissions.*') ? 'active' : '' }}">Roles & Permissions</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
            ...
            <div class="d-xl-flex align-items-center d-none">
                <a href="#" class="me-3 avatar avatar-sm">
                    <img src="{{ asset('img/profiles/avatar-07.jpg') }}" alt="profile" class="rounded-circle">
                </a>
        ...
        <div class="twocol-mini">
            ...
            <div class="sidebar-left slimscroll">
                <div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
                    ...
                    <a href="#" class="nav-link" title="Content" data-bs-toggle="tab"
        ...
        <div class="sidebar-right">
            ...
            <div class="sidebar-scroll">
                ...
                <div class="text-center rounded bg-light p-3 mb-4">
                    <div class="avatar avatar-lg online mb-3">
                        <img src="{{ asset('img/profiles/avatar-02.jpg') }}" alt="Img"
            ...
            <div class="sidebar-scroll">
                ...
                <div class="stack-menu">
                    <div class="nav flex-column align-items-center nav-pills" role="tablist"
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                <a href="#menu-dashboard" role="tab" class="nav-link active"
                            ...
                            <div class="col-6">
                                <a href="#menu-crm" role="tab" class="nav-link" title="CRM"
                                    data-bs-toggle="tab" data-bs-target="#menu-crm" aria-selected="false">
                                    <span><i class="ti ti-user-shield"></i></span>
                                    <p>Crm</p>
                                </a>
                            </div>
                            <div class="col-6">
                                <a href="#menu-hrm" role="tab" class="nav-link" title="HRM"
                                    data-bs-toggle="tab" data-bs-target="#menu-hrm" aria-selected="false">
                                    <span><i class="ti ti-users"></i></span>
                                    <p>Hrm</p>
                                </a>
                            </div>
                            <div class="col-6">
                                <a href="#menu-finance" role="tab" class="nav-link"
